...
<div class="mod_jl_results<?php echo $params->get( 'moduleclass_sfx' ) ?>">
	...
	<?php if ($params->get('show_full_link', 1)):?>
		<div class="mod_jl_results_fulltablelink<?php echo $params->get( 'moduleclass_sfx' ) ?>"><?php echo JHTML::link(JoomleagueHelperRoute::getResultsRoute($list['project']->id, $list['round']->id), JText::_('VIEW FULL')); ?></div>
	<?php endif; ?>
