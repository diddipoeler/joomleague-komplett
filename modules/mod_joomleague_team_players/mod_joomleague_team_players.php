...
/**
 * @version	 $Id: mod_joomleague_team_players.php ingalb$
 * @package	 Joomla
...
//add css file
$document->addStyleSheet(JURI::base().'modules/mod_joomleague_team_players/css/mod_joomleague_team_players.css');

require(JModuleHelper::getLayoutPath('mod_joomleague_team_players'));