...
$selectiondate = modJoomleagueTickerHelper::getSelectionDate($params->get('daysback'), $params->get('offset'));
...
$date = modJoomleagueTickerHelper::getCorrectDateFormat($params->get('dateformat'),$matches);
