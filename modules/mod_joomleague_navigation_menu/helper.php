...
class modJoomleagueNavigationMenuHelper {
	...
	public function __construct($params)
	{
		...
		$this->_team_id   = JRequest::getInt('tid');
	}
	...
	public function getTeamSelect()
	{
		...
		return JHTML::_('select.genericlist', $options, 'tid', 'class="jlnav-team"', 'value', 'text', $this->_team_id);		
	}
	...
	public function getLink($view)
	{
		...
		{								
			case "calendar":
				$link = JoomleagueHelperRoute::getTeamPlanRoute( $this->_project_id, 0 );
				break;	
				
			case "curve":
				$link = JoomleagueHelperRoute::getCurveRoute( $this->_project_id );
				break;
				
			case "eventsranking":				
				$link = JoomleagueHelperRoute::getEventsRankingRoute( $this->_project_id );
				break;

			case "matrix":
				$link = JoomleagueHelperRoute::getMatrixRoute( $this->_project_id );
				break;
			...
			case "results":
				$link = JoomleagueHelperRoute::getResultsRoute( $this->_project_id );
				break;
				
			case "resultsmatrix":
				$link = JoomleagueHelperRoute::getResultsMatrixRoute( $this->_project_id );
				break;

			case "resultsranking":
				$link = JoomleagueHelperRoute::getResultsRankingRoute( $this->_project_id );
				break;
				
			case "resultsrankingmatrix":
				$link = JoomleagueHelperRoute::getResultsRankingMatrixRoute( $this->_project_id );
				break;
			...
			case "stats":
				$link = JoomleagueHelperRoute::getStatsRoute( $this->_project_id );
				break;
				
			case "statsranking":
				$link = JoomleagueHelperRoute::getStatsRankingRoute( $this->_project_id );
				break;
			...
			case "teamplan":
				...
				$link = JoomleagueHelperRoute::getTeamPlanRoute( $this->_project_id, $this->_team_id );
				break;		
			...
			default:
			case "ranking":
				$link = JoomleagueHelperRoute::getRankingRoute( $this->_project_id );
		}
		return $link;
	}
