...
if ($data['projectscount'] == 0) {
	echo '<p class="modjlgsports">' . JText::_('MOD_JLG_SPORTS_TYPE_STATISTICS_NO_PROJECTS') . '</p>';
	return;
} else {
	?>
<div class="modjlgsports <?PHP echo $params->get( 'moduleclass_sfx' ); ?>">
	...
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_PROJECTS"); ?></li>
		<li class="text <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo $data['projectscount']?></li>
	</ul>
	<?php } ?>
	<?php if($params->get('show_leagues',1) == 1) { ?>
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_LEAGUES"); ?></li>
		<li class="text <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo $data['leaguescount']?></li>
	</ul>
	<?php } ?>
	<?php if($params->get('show_seasons',1) == 1) { ?>
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_SEASONS"); ?></li>
		<li class="text <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo $data['seasonscount']?></li>
	</ul>
	<?php } ?>
	<?php if($params->get('show_teams',1) == 1) { ?>
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_TEAMS"); ?></li>
		<li class="text <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo $data['projectteamscount']?></li>
	</ul>
	<?php } ?>
	<?php if($params->get('show_players',1) == 1) { ?>
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_PLAYERS"); ?></li>
	...
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_DIVISIONS"); ?></li>
	...
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_ROUNDS"); ?></li>
		<li class="text <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo $data['projectroundscount']?></li>
	</ul>
	<?php } ?>
	<?php if($params->get('show_matches',1) == 1) { ?>
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_MATCHES"); ?></li>
	...
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_PLAYER_EVENTS"); ?></li>
	...
	<ul>
		<li class="label <?PHP echo $params->get( 'moduleclass_sfx' ); ?>"><?php echo JText::_("MOD_JLG_SPORTS_TYPE_STATISTICS_PLAYER_STATS"); ?></li>
