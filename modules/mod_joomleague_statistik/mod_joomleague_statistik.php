...
//$p  = $params->get('project_id');

//$list  = modJLGStatistikHelper::getData($params);
/*
$list  = modJLGStatistikHelper::getData();
...
//add css file
//$document->addStyleSheet(JURI::base().'modules/mod_joomleague_statistik/css/mod_joomleague_statistik.css');

require(JModuleHelper::getLayoutPath('mod_joomleague_statistik'));