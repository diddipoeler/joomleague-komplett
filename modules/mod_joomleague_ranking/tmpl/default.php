...
if (count($columns) != count($column_names)) {
	JError::raiseWarning(1, JText::_('COLUMN NAMES COUNT MISMATCH'));
	$columns     = array();
	$column_name = array();
}
...
<table class="ranking">
	<thead>
		<tr class="sectiontableheader">
			<th class="rank"><?php echo JText::_('MOD RANKING COL RANK')?></th>
			<th class="team"><?php echo JText::_('MOD RANKING COL TEAM')?></th>
...
<p class="fulltablelink"><?php 
	...
	echo JHTML::link(JoomleagueHelperRoute::getRankingRoute($list['project']->slug, null, null, null, null, $divisionid), JText::_('VIEW FULL TABLE')); ?></p>
<?php endif; ?>
</div>