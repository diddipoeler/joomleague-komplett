...
//add css file
$document->addStyleSheet(JURI::base().'modules/mod_joomleague_top_tipper_16/css/mod_joomleague_top_tipper_16.css');
...
require(JModuleHelper::getLayoutPath('mod_joomleague_top_tipper_16'));
?>