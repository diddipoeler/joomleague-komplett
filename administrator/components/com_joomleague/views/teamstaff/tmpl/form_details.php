...
?>		
			...
			<legend>
				<?php
				echo JText::sprintf(	'JL_ADMIN_TEAMSTAFF_DETAILS_TITLE',
			...
			<table class="admintable" border="0">
				<tr>
					<td width="20%" valign="top" align="right" class="key">
						<label for="position">
							<?php
								echo JText::_( 'JL_ADMIN_TEAMSTAFF_POS' );
							?>
						</label>
					</td>
					<td colspan="7">
				...
				<tr>
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_INJURED' );
						?>
					</td>
					<td nowrap="nowrap">
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_INJURY_DATE' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_INJURY_END' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_INJURY_TYPE' );
						?>
					</td>
					<td>
				...
				<tr>
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_SUSPENDED' );
						?>
					</td>
					<td nowrap="nowrap">
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_SUSPENSION_DATE' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_SUSPENSION_END' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_SUSPENSION_TYPE' );
						?>
					</td>
					<td>
				...
				<tr>
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_AWAY' );
						?>
					</td>
					<td nowrap="nowrap">
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_AWAY_DATE' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_AWAY_END' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMSTAFF_AWAY_TYPE' );
						?>
					</td>
					<td>
