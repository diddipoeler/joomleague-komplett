...
class JoomleagueViewPosition extends JLGView
{
	...
	function _displayForm($tpl)
	{
		...
		{
			$msg=JText::sprintf('DESCBEINGEDITTED',JText::_('JL_ADMIN_POSITION_THEPOSITION'), JText::_($position->name));
		...
		$parents[]=JHTML::_('select.option','',JText::_('JL_ADMIN_POSITION_IS_P_POSITION'));
		...
		$sports_type[]=JHTML::_('select.option','0',JText::_('JL_ADMIN_POSITION_SELECT_SPORTSTYPE'),'id','name');
		...
		$person_type=array (	JHTML::_('select.option','1',JText::_('JL_F_PLAYERS'),'id','name'),
					JHTML::_('select.option','2',JText::_('JL_F_TEAM_STAFF'),'id','name'),
					JHTML::_('select.option','3',JText::_('JL_F_REFEREES'),'id','name'),
					JHTML::_('select.option','4',JText::_('JL_F_CLUB_STAFF'),'id','name')
							);
