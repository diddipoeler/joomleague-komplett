...
if (!$edit)
{
	JToolBarHelper::title(JText::_('JL_ADMIN_LEAGUE_ADD_NEW'),'leagues');
...
else
{
	...
	JToolBarHelper::title(JText::_('JL_ADMIN_LEAGUE_EDIT'),'leagues');
...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton)
	{
		...
		if (form.name.value == "")
		{
			alert("<?php echo JText::_('JL_ADMIN_LEAGUE_NO_NAME',true); ?>");
		}
		else
		{
			submitform(pressbutton);
		...
		{
			alert("<?php echo JText::_('JL_ADMIN_LEAGUE_NO_SHORT_NAME',true); ?>");
		}
		else
		{
			submitform(pressbutton);
