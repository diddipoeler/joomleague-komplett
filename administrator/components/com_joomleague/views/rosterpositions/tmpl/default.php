	...
	<div id="editcell">
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th class="title" nowrap="nowrap" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_ROSTERPOSITIONS_NAME','obj.name',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>
					<th class="title" nowrap="nowrap" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_ROSTERPOSITIONS_SHORT_NAME','obj.name',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>					
					<th width="10%" class="title" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_ROSTERPOSITIONS_COUNTRY','obj.country',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>
			...
			<tbody>
				...
				{
					$row =& $this->items[$i];
					$link=JRoute::_('index.php?option=com_joomleague&controller=rosterposition&task=edit&cid[]='.$row->id);
						...
						else
						{
							...
							<td style="text-align:center; ">
								<a href="<?php echo $link; ?>">
									<?php
									$imageTitle=JText::_('JL_ADMIN_ROSTERPOSITIONS_EDIT_DETAILS');
