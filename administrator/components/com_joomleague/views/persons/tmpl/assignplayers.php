				...
				<thead>
					...
					<th width="20" style="vertical-align: top; ">
						...
						<th class="title" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_ADMIN_PERSONS_L_NAME','pl.lastname',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						<th class="title" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_ADMIN_PERSONS_F_NAME','pl.firstname',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						<th class="title" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_ADMIN_PERSONS_N_NAME','pl.nickname',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						
            <th class="title" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_ADMIN_PERSONS_INFO','pl.info',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						
						<th class="title" nowrap="nowrap"><?php echo JText::_('JL_ADMIN_PERSONS_IMAGE'); ?></th>
						<th class="title" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_ADMIN_PERSONS_BIRTHDAY','pl.birthday',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						<th class="title" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_ADMIN_PERSONS_NATIONALITY','pl.country',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						<th width="1%" nowrap="nowrap">
							<?php echo JHTML::_('grid.sort','JL_GLOBAL_ID','pl.id',$this->lists['order_Dir'],$this->lists['order']); ?>
						</th>
						...
						if (($row->firstname != '!Unknown') && ($row->lastname != '!Player')) // Ghostplayer for match-events
						{
							...
							<tr class="<?php echo "row$k"; ?>">
								...
								<td style="text-align:center; ">
									...
									if ($row->picture == '')
									{
										$imageTitle=JText::_('JL_ADMIN_PERSONS_NO_IMAGE');
								...
								<td nowrap="nowrap" style="text-align:center; "><?php echo JoomleagueHelper::convertDate($row->birthday); ?></td>
								<td nowrap="nowrap" style="text-align:center; "><?php echo Countries::getCountryFlag($row->country); ?></td>
