...
class JoomleagueViewStatistics extends JLGView
{
	function display($tpl=null)
	{
		...
		JToolBarHelper::title(JText::_('JL_ADMIN_STATISTICS_TITLE'),'statistics');
		...
		JToolBarHelper::divider();
		JToolBarHelper::deleteList(JText::_('JL_ADMIN_STATISTICS_DELETE_WARNING'),'fulldelete',JTEXT::_('JL_ADMIN_STATISTICS_FULL_DELETE'));
		JToolBarHelper::divider();
