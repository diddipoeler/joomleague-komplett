...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm">
	...
	<div id="editcell">
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th class="title" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_SPORTSTYPES_NAME','s.name',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>
					<th class="title" style="vertical-align: top; ">
						<?php echo JText::_('JL_ADMIN_SPORTSTYPES_TRANSLATION'); ?>
					</th>
					<th width="10%" class="title" style="vertical-align: top; ">
						<?php echo JText::_('JL_ADMIN_SPORTSTYPES_ICON'); ?>
					</th>					
					<th width="85" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_GLOBAL_ORDER','s.ordering',$this->lists['order_Dir'],$this->lists['order']);
						echo '<br />';
						echo JHTML::_('grid.order',$this->items);
						?>
					</th>
					<th style="vertical-align: top; ">
						<?php echo JHTML::_('grid.sort','JL_GLOBAL_ID','s.id',$this->lists['order_Dir'],$this->lists['order']); ?>
					</th>
				</tr>
			</thead>
			...
			<tbody>
				...
				{
					$row =& $this->items[$i];
					$link=JRoute::_('index.php?option=com_joomleague&controller=sportstype&task=edit&cid[]='.$row->id);
						...
						else
						{
							...
							<td style="text-align:center; ">
								<a href="<?php echo $link; ?>">
									<?php
									$imageTitle=JText::_('JL_ADMIN_SPORTSTYPES_EDIT_DETAILS');
	...
	<input type="hidden" name="controller" value="sportstype" />
