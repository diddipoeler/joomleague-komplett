...
?>
	<fieldset class="adminform">
		<legend>
			<?php
			echo JText::sprintf(	'JL_ADMIN_TREETONODE_TITLE_DESCRIPTION',
									'<i>' . $this->node->node . '</i>',
			...
			<table class="admintable" border="0">
				<tr>
					<td nowrap="nowrap" class="key" style="text-align:right; ">
						<?php echo JText::_('JL_ADMIN_TREETONODE_TITLE_NODE'); ?>
					</td>
					<td>
				...
				<tr>
					<td nowrap="nowrap" class="key" style="text-align:right; ">
						<?php echo JText::_('JL_ADMIN_TREETONODE_CONTENT_NODE'); ?>
					</td>
					<td>
				...
				<tr>
					<td nowrap="nowrap" class="key" style="text-align:right; ">
						<?php echo JText::_('JL_ADMIN_TREETONODE_TEAM'); ?>
					</td>
					<td>
				<?php
				$append='';
