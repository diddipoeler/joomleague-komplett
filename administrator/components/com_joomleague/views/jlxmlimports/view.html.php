...
public function dump_variable($name, $value)
{
    ...
    $this->assignRef('import_existing_color', JComponentHelper::getParams('com_joomleague')->get('import_existing_color') );
		$this->assignRef('import_new_entry_color', JComponentHelper::getParams('com_joomleague')->get('import_new_entry_color') );
		$this->assignRef('import_club_existing_color', JComponentHelper::getParams('com_joomleague')->get('import_club_existing_color') );
