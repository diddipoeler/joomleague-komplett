...
<div id="editcell">
	<form enctype='multipart/form-data' action='<?php echo $this->request_url; ?>' method='post' name='adminForm'>
		<table class='adminlist'>
			<thead><tr><th><?php echo JText::sprintf('JL_ADMIN_XML_IMPORT_TABLE_TITLE_1',$this->config->get('upload_maxsize') / 1000000 ); ?></th></tr></thead>
			<tfoot><tr><td><?php
				echo '<p>';
					echo '<b>'.JText::_('JL_ADMIN_XML_IMPORT_EXTENSION_INFO').'</b>';
				echo '</p>';
				echo '<p>';
					echo JText::_('JL_ADMIN_XML_IMPORT_HINT1').'<br>';
				echo '</p>';
				?></td></tr></tfoot>
