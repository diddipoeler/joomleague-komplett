	...
	<div id="editcell">
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th class="title" style="vertical-align: top; ">
						<?php echo JHTML::_('grid.sort','JL_ADMIN_SEASONS_NAME','s.name',$this->lists['order_Dir'],$this->lists['order']); ?>
					</th>
			...
			<tbody>
				...
				{
					$row =& $this->items[$i];
					$link=JRoute::_('index.php?option=com_joomleague&controller=season&task=edit&cid[]='.$row->id);
						...
						else
						{
							...
							<td style="text-align:center; ">
								<a href="<?php echo $link; ?>">
									<?php
									$imageTitle=JText::_('JL_ADMIN_SEASONS_EDIT_DETAILS');
