...
?>
		...
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'JL_ADMIN_DIVISION_PIC' );?>
			</legend>
			<table class="admintable">
			    ...
			    <tr>
			      <td width="250" align="right" class="key">
			        <label for="image">
			          <span class="hasTip" title='<?php echo JText::_( 'JL_ADMIN_DIVISION_EDIT_PICTURE' ); ?>::<?php echo JText::_( 'JL_ADMIN_LEAGUE_EDIT_PICTURE' ); ?>'>
			            <?php echo JText::_( 'JL_ADMIN_DIVISION_EDIT_PICTURE' ).':'; ?>
			          </span>
			        </label>
			      </td>
			      <td>
