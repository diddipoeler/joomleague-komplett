...
JToolBarHelper::title( JText::_( 'JL_ADMIN_TPLAYERS_TITLE' ) );

JToolBarHelper::publishList();
JToolBarHelper::unpublishList();
JToolBarHelper::apply( 'saveshort', JText::_( 'JL_ADMIN_TPLAYERS_APPLY' ) );
JToolBarHelper::divider();

JToolBarHelper::custom( 'assign', 'upload.png', 'upload_f2.png', JText::_( 'JL_ADMIN_TPLAYERS_ASSIGN' ), false );
JToolBarHelper::custom( 'unassign', 'cancel.png', 'cancel_f2.png', JText::_( 'JL_ADMIN_TPLAYERS_UNASSIGN' ), false );
JToolBarHelper::divider();

JToolBarHelper::back( 'JL_ADMIN_TPLAYERS_BACK', 'index.php?option=com_joomleague&view=projectteams&controller=projectteam' );
JToolBarHelper::divider();
...
var quickaddsearchurl = '<?php echo JURI::root();?>administrator/index.php?option=com_joomleague&controller=quickadd&task=searchplayer&projectteam_id=<?php echo $this->teamws->id; ?>';
...
<fieldset class="adminform">
	<legend>
	<?php
	echo JText::_("JL_ADMIN_TEAMPLAYERS_QUICKADD_PLAYER");
	?>
	</legend>
	<form name="quickaddForm" action="<?php echo JURI::root(); ?>administrator/index.php?option=com_joomleague&controller=quickadd&task=addplayer" method="post">
	...
	<table>
		<tr>
			<td><?php echo JText::_('JL_ADMIN_TEAMPLAYERS_QUICKADD_DESCR');?>:</td>
...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm">
	<fieldset class="adminform">
		<legend>
			<?php
			echo JText::sprintf(	'JL_ADMIN_TPLAYERS_TITLE2',
		...
		<div id="editcell">
			<table class="adminlist">
				<thead>
					<tr>
						...
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_ADMIN_TPLAYERS_NAME', 'ppl.lastname', $this->lists['order_Dir'], $this->lists['order'] );
							?>
						</th>
						...
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JText::_( 'JL_ADMIN_TPLAYERS_IMAGE' );
							?>
						</th>
						<th width="20" class="title" style="vertical-align: top; ">
							<?php
							echo JText::_( 'JL_ADMIN_TPLAYERS_SHIRTNR' );
							?>
						</th>
						<th width="20" nowrap="nowrap" class="title" style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_ADMIN_TPLAYERS_POS', 'tp.project_position_id', $this->lists['order_Dir'], $this->lists['order'] );
							?>
						</th>
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JText::_( 'JL_ADMIN_TPLAYERS_STATUS' );
							?>
						</th>
						<th class="title" nowrap="nowrap" style="vertical-align: top;">
						<?php
						echo JHTML::_('grid.sort','JL_GLOBAL_PUBLISHED','tp.published',$this->lists['order_Dir'],$this->lists['order']);
						?></th>
						<th width="85" style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_GLOBAL_ORDER', 'ppl.ordering', $this->lists['order_Dir'], $this->lists['order'] );
							echo '<br />';
						...
						<th style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_GLOBAL_ID', 'tpid', $this->lists['order_Dir'], $this->lists['order'] );
							?>
						</th>
					</tr>
				</thead>
				...
				<tbody>
					...
					{
						$row =& $this->items[$i];
						$link			= JRoute::_('index.php?option=com_joomleague&controller=teamplayer&task=edit&team=' .
						...
						<tr class="<?php echo "row$k"; ?>">
							...
							else
							{
								...
								<td style="text-align:center; ">
									<a href="<?php echo $link; ?>">
										<?php
										$imageTitle = JText::_( 'JL_ADMIN_TPLAYERS_EDIT_DETAILS' );
							...
							<td style="text-align:center; ">
								...
								if ( $row->picture == '' )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TPLAYERS_NO_IMAGE' );
									echo JHTML::_(	'image',
								...
								{
										$imageTitle = JText::_( 'JL_ADMIN_TPLAYERS_DEFAULT_IMAGE' );
										echo JHTML::_(	'image',
							...
							<td nowrap="nowrap" style="text-align:center; ">
								...
								if ( $row->injury > 0 )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TPLAYERS_INJURED' );
								...
								if ( $row->suspension > 0 )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TPLAYERS_SUSPENDED' );
								...
								if ( $row->away > 0 )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TPLAYERS_AWAY' );
