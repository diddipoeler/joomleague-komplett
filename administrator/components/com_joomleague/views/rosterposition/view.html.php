...
class JoomleagueViewrosterposition extends JLGView
{
	...
	function _displayForm($tpl)
	{
		...
		{
			$msg=JText::sprintf('DESCBEINGEDITTED',JText::_('JL_ADMIN_ROSTERPOSITION'),$object->name);
		...
		$countries[]=JHTML::_('select.option','',JText::_('JL_ADMIN_ROSTERPOSITIONS_SELECT_COUNTRY'));
