...
JToolBarHelper::title( JText::_( 'JL_ADMIN_TSTAFFS_TITLE' ) );

JToolBarHelper::publishList();
JToolBarHelper::unpublishList();
JToolBarHelper::apply( 'saveshort', JText::_( 'JL_ADMIN_TSTAFFS_APPLY' ) );
JToolBarHelper::divider();

JToolBarHelper::custom( 'assign', 'upload.png', 'upload_f2.png', JText::_( 'JL_ADMIN_TSTAFFS_ASSIGN' ), false );
JToolBarHelper::custom( 'unassign', 'cancel.png', 'cancel_f2.png', JText::_( 'JL_ADMIN_TSTAFFS_UNASSIGN' ), false );
JToolBarHelper::divider();

JToolBarHelper::back( 'JL_ADMIN_TSTAFFS_BACK', 'index.php?option=com_joomleague&view=projectteams&controller=projectteam' );
JToolBarHelper::divider();
...
<script language="javascript">
	...
	var quickaddsearchurl = '<?php echo JURI::root();?>administrator/index.php?option=com_joomleague&controller=quickadd&task=searchstaff&projectteam_id=<?php echo $this->teamws->id; ?>';
...
<fieldset class="adminform">
	<legend>
	<?php
	echo JText::_("JL_ADMIN_TEAMSTAFFS_QUICKADD_STAFF");
	?>
	</legend>
	<form name="quickaddForm" action="<?php echo JURI::root(); ?>administrator/index.php?option=com_joomleague&controller=quickadd&task=addstaff" method="post">
	...
	<table>
		<tr>
			<td><?php echo JText::_('JL_ADMIN_TEAMSTAFFS_QUICKADD_DESCR');?>:</td>
...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm">
	<fieldset class="adminform">
		<legend>
			<?php
			echo JText::sprintf(	'JL_ADMIN_TSTAFFS_TITLE2',
				...
				<thead>
					<tr>
						...
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_ADMIN_TSTAFFS_NAME', 'ppl.lastname', $this->lists['order_Dir'], $this->lists['order'] );
							?>
						</th>
						<th width="20" style="vertical-align: top; ">
							<?php
							echo JText::_( 'JL_ADMIN_TSTAFFS_PID' );
							?>
						</th>
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JText::_( 'JL_ADMIN_TSTAFFS_IMAGE' );
							?>
						</th>
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_ADMIN_TSTAFFS_POS', 'ppl.project_position_id', $this->lists['order_Dir'], $this->lists['order'] );
							?>
						</th>
						<th class="title" nowrap="nowrap" style="vertical-align: top; ">
							<?php
							echo JText::_( 'JL_ADMIN_TSTAFFS_STATUS' );
							?>
						</th>
						<th class="title" nowrap="nowrap" style="vertical-align: top;">
						<?php
						echo JHTML::_('grid.sort','JL_GLOBAL_PUBLISHED','ts.published',$this->lists['order_Dir'],$this->lists['order']);
						?></th>
						...
						<th width="1%" style="vertical-align: top; ">
							<?php
							echo JHTML::_( 'grid.sort', 'JL_GLOBAL_ID', 'ppl.id', $this->lists['order_Dir'], $this->lists['order'] );
							?>
						</th>
					</tr>
				</thead>
...
#echo '<pre>'; print_r($row); echo '</pre>';
						$link = JRoute::_(	'index.php?option=com_joomleague&controller=teamstaff&task=edit&team=' .
						...
						<tr class="<?php echo "row$k"; ?>">
							...
							else
							{
								...
								<td style="text-align:center; ">
									<a href="<?php echo $link; ?>">
										<?php
										$imageTitle = JText::_( 'JL_ADMIN_TSTAFFS_EDIT_DETAILS' );
							...
							<td style="text-align:center; ">
								...
								if ( $row->picture == '' )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TSTAFFS_NO_IMAGE' );
									echo JHTML::_(	'image',
								...
								{
										$imageTitle = JText::_( 'JL_ADMIN_TSTAFFS_DEFAULT_IMAGE' );
										echo JHTML::_(	'image',
							...
							<td nowrap="nowrap" style="text-align:center; ">
								...
								if ( $row->injury > 0 )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TSTAFFS_INJURED' );
								...
								if ( $row->suspension > 0 )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TSTAFFS_SUSPENDED' );
								...
								if ( $row->away > 0 )
								{
									$imageTitle = JText::_( 'JL_ADMIN_TSTAFFS_AWAY' );
	...
	<input type="hidden" name="controller"			value="teamstaff" />
