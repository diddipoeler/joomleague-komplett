...
?>			
		<fieldset class="adminform">
			<legend>
				<?php
				echo JText::sprintf('JL_ADMIN_TEAMPLAYER_DETAILS_TITLE',
			...
			<table class="admintable">
				<tr>
					<td width="20%" valign="top" align="right" class="key">
						<label for="position">
							<?php
								echo JText::_( 'JL_ADMIN_TEAMPLAYER_POS' );
							?>
						</label>
					</td>
					<td>
					...
					<td width="20%" valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_JERSEYNR' );
						?>
					</td>
					<td colspan="7">
				...
				<tr>
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_INJURED' );
						?>
					</td>
					<td nowrap="nowrap">
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_INJURY_DATE' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_INJURY_END' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_INJURY_TYPE' );
						?>
					</td>
					<td>
				...
				<tr>
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_SUSPENDED' );
						?>
					</td>
					<td nowrap="nowrap">
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_SUSPENSION_DATE' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_SUSPENSION_END' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_SUSPENSION_TYPE' );
						?>
					</td>
					<td>
				...
				<tr>
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_AWAY' );
						?>
					</td>
					<td nowrap="nowrap">
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_AWAY_DATE' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_AWAY_END' );
						?>
					</td>
					<td>
						<?php
					...
					<td valign="top" align="right" class="key">
						<?php
						echo JText::_( 'JL_ADMIN_TEAMPLAYER_AWAY_TYPE' );
						?>
					</td>
					<td>
