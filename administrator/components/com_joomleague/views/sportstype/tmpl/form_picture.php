...
?>
		...
		<fieldset class="adminform">
			<legend><?php echo JText::_( 'JL_ADMIN_SPORTTYPE_PIC' );?>
			</legend>
			<table class="admintable">
			    ...
			    <tr>
			      <td width="250" align="right" class="key">
			        <label for="image">
			          <span class="hasTip" title='<?php echo JText::_( 'JL_ADMIN_SPORTTYPE_ICON' ); ?>::<?php echo JText::_( 'JL_ADMIN_SPORTTYPE_ICON' ); ?>'>
			            <?php echo JText::_( 'JL_ADMIN_SPORTTYPE_ICON' ).':'; ?>
			          </span>
			        </label>
			      </td>
			      <td>
