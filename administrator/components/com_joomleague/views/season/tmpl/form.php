...
if (!$edit)
{
	JToolBarHelper::title(JText::_('JL_ADMIN_SEASON_ADD_NEW'),'seasons');
...
else
{
	...
	JToolBarHelper::title(JText::_('JL_ADMIN_SEASON_EDIT'),'seasons');
...
<script language="javascript" type="text/javascript">
	function submitbutton(pressbutton)
	{
		...
		if (form.name.value == "")
		{
			alert("<?php echo JText::_('JL_ADMIN_SEASON_NO_NAME',true); ?>");
		}
		else
			{
			submitform(pressbutton);
