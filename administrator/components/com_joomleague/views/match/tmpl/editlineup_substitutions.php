...
var str_delete="<?php echo JText::_('JL_GLOBAL_REMOVE'); ?>";
//-->
</script>
<!-- SUBSTITUTIONS START -->
<div id="io">
	...
	<div id="ajaxresponse"></div>
		<fieldset class="adminform">
			<legend><?php echo JText::_('JL_ADMIN_MATCH_ELUSUBST_SUBST'); ?></legend>
				...
				<thead>
					<tr>
						<th>
							...
							echo '&nbsp;'.JText::_('JL_ADMIN_MATCH_ELUSUBST_OUT');
							?>
						</th>
						<th>
							<?php
							echo JText::_('JL_ADMIN_MATCH_ELUSUBST_IN').'&nbsp;';
							echo JHTML::_('image','administrator/components/com_joomleague/assets/images/in.png',JText::_('In'));
							?>
						</th>
						<th><?php echo JText::_('JL_ADMIN_MATCH_ELUSUBST_POS'); ?></th>
						<th><?php echo JText::_('JL_ADMIN_MATCH_ELUSUBST_TIME'); ?></th>
						<th>&nbsp;</th>
					</tr>
				</thead>
				<tbody>
						...
						<tr id="sub-<?php echo $substitution->id; ?>" class="<?php echo "row$k"; ?>">
							...
							<td>
								<input	id="delete-<?php echo $substitution->id; ?>" type="button" class="inputbox button-delete"
										value="<?php echo JText::_('JL_GLOBAL_REMOVE'); ?>" />
							</td>
						</tr>
						<?php
						$k=(1-$k);
