...
?>
		<fieldset class="adminform">
			<legend><?php echo JText::_('JL_ADMIN_MATCH_ELUS'); ?></legend>
			<table class='adminlist'>
			<thead>
				<tr>
					<th>
						<?php echo JText::_('JL_ADMIN_MATCH_ELUS_STAFF'); ?>
					</th>
					<th>
						<?php echo JText::_('JL_ADMIN_MATCH_ELUS_ASSIGNED'); ?>
					</th>					
				</tr>
			</thead>				
				<tr>
					<td colspan="2">
					<input type="submit" class="inputbox"	value="<?php echo JText::_('JL_GLOBAL_SAVE'); ?>" /></td>
				</tr>
				<tr>
