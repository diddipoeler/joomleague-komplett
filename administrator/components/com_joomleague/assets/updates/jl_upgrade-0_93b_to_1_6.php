...
$updatefilename		= 'jl_update-0_93b-1_6';
$updateFileDate		= '2012-04-04';
$updateFileTime		= '23:10';
$lastVersion		= '0.93b';
$JLtablePrefix		= 'joomleague';
$updateDescription	= '<span style="color:orange">Perform an update of existing old JL 0.93b tables inside the database to work with JoomLeague v1.6.0</span>';
$excludeFile		= 'false';
...
function addStandardsForSoccer()
{
...

	{
		...
		$newEventIcon='media/com_joomleague/event_icons/goal.png';
		...
		$newEventIcon='media/com_joomleague/event_icons/assists.gif';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
		...
		$newEventIcon='media/com_joomleague/event_icons/yellow_card.gif';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
		...
		$newEventIcon='media/com_joomleague/event_icons/yellow_red_card.gif';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
		...
		$newEventIcon='media/com_joomleague/event_icons/red_card.gif';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
		...
		$newEventIcon='media/com_joomleague/event_icons/foul.png';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
		...
		$newEventIcon='media/com_joomleague/event_icons/foul_time.png';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
		...
		$newEventIcon='media/com_joomleague/event_icons/own_goal.png';
		$query=build_SelectQuery('eventtypes',$newEventName); $db->setQuery($query);
		if (!$object=$db->loadObject())
		{
...
*/      
      ...
      $eventtype->name = $eventtype->name;
			...
			if ($pos ===false)
			{
				$eventtype->icon='media/com_joomleague/event_icons/'.$eventtype->icon;
			}
