...
*/
	window.addEvent('domready', function() {
		...
		$ES('input.hs-move-right').addEvent('click', function() {
			$('changes_check').value=1;
		...
		$ES('input.hs-move-left').addEvent('click', function() {
			$('changes_check').value=1;
		...
		// home staff move up
		$ES('input.hs-move-up').addEvent('click', function() {
			$('changes_check').value=1;
		...
		$ES('input.hs-move-down').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		$ES('input.hp-move-right').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(14);
		...
		$ES('input.hp-move-left').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		// home player move up
		$ES('input.hp-move-up').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(11);
		...
		$ES('input.hp-move-down').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		$ES('input.as-move-right').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(14);
		...
		$ES('input.as-move-left').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		// away staff move up
		$ES('input.as-move-up').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(11);
		...
		$ES('input.as-move-down').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		$ES('input.ap-move-right').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(14);
		...
		$ES('input.ap-move-left').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		// away player move up
		$ES('input.ap-move-up').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(11);
		...
		$ES('input.ap-move-down').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		$ES('input.mr-move-right').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(14);
		...
		$ES('input.mr-move-left').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		$ES('input.mr-move-up').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(11);
		...
		$ES('input.mr-move-down').addEvent('click', function() {
			$('changes_check').value=1;
			var posid = this.id.substr(13);
		...
		$ES('input.button-save-homesubst').addEvent('click', function() {
		...
		$ES('input.button-save-awaysubst').addEvent('click', function() {
			var url = baseajaxurl+'&task=savesubst';
			var rowid = this.id.substr(5);
