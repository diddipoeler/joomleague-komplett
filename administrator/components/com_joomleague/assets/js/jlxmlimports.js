...
function insertClubAndTeam(anId)
{
	...
	// diddipoeler
	adminform['dbClubName_'+anId].style.backgroundColor='lightgreen';
	adminform['dbClubCountry_'+anId].style.backgroundColor='lightgreen';
	adminform['impClubName_'+anId].style.backgroundColor='lightgreen';
	adminform['impClubCountry_'+anId].style.backgroundColor='lightgreen';
	adminform['dbTeamName_'+anId].style.backgroundColor='lightgreen';
	adminform['impTeamName_'+anId].style.backgroundColor='lightgreen';
