 ...
 * @since	0.1
 */
class JoomleagueControllerTreeto extends JoomleagueCommonController
{
	...
	function saveshort()
	{
		...
		{
			$msg = JText::_('JL_ADMIN_TREETO_CTRL_SAVED');
		}
		else
		{
			$msg = JText::_('JL_ADMIN_TREETO_CTRL_ERROR_SAVED') . $model->getError();
		}
	...
	function generatenode()
	{
		...
		{
			$msg=JText::_('JL_ADMIN_TREETO_CTRL_GENERATE_NODE');
			$link = 'index.php?option=com_joomleague&controller=treetonode&view=treetonodes&tid[]='.$post['id'];
		}
		else
		{
			$msg=JText::_('JL_ADMIN_TREETO_CTRL_ERROR_GENERATE_NODE').$model->getError();
			$link = 'index.php?option=com_joomleague&controller=treeto&task=gennode&cid[]='.$post['id'];
		}
		$this->setRedirect( $link, $msg );
	}
	...
	function save()
	{
		...
		{
			$link='index.php?option=com_joomleague&view=treetos&controller=treeto';
		}
		else
		{
			$link='index.php?option=com_joomleague&controller=treeto&task=edit&cid[]='.$post['id'];
		}
		$this->setRedirect($link,$msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect('index.php?option=com_joomleague&controller=treeto&view=treetos');
	}
