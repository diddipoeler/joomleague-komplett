...
class JoomleagueControllerMatch extends JoomleagueCommonController
{
	...
	function saveshort()
	{
		...
		$msg=JText::_('JL_ADMIN_MATCH_CTRL_SAVED_MATCH');
		$link='index.php?option=com_joomleague&controller=match&view=matches';
		$this->setRedirect($link,$msg);
	}
