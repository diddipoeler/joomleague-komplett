 ...
 * @since	0.1
 */
class JoomleagueControllerTreetomatch extends JoomleagueCommonController
{
	...
	function save_matcheslist()
	{
		...
		if ($model->store($post))
		{
			$msg = JText::_('JL_ADMIN_TREETOMATCH_CTRL_SAVED');
		}
		else
		{
			$msg = JText::_('JL_ADMIN_TREETOMATCH_CTRL_ERROR_SAVE') . $model->getError();
		}
