 ...
 * @since	0.1
 */
class JoomleagueControllerJlextassociations extends JoomleagueCommonController
{
	...
	function save()
	{
		...
		{
			$link='index.php?option=com_joomleague&controller=jlextassociation&task=edit&cid[]='.$post['id'];
		}
