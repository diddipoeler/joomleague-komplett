...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm">
		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="20" style="vertical-align: top; ">
						<?php echo JHTML::_('grid.sort','JL_GLOBAL_ID','objassoc.id',$this->lists['order_Dir'],$this->lists['order']); ?>
					</th>
				</tr>
			</thead>
			...
			<tbody>
				...
				{
					$row =& $this->items[$i];
					$link=JRoute::_('index.php?option=com_joomleague&controller=jlextassociations&task=edit&cid[]='.$row->id);
	...
	<input type="hidden" name="controller" value="jlextassociations" />
