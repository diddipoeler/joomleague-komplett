...
// 					$published = JHTML::_('grid.published',$row,$i);
            ...
            <td style="text-align:center; ">
                ...
                <a href="<?php echo $link; ?>">
									<?php
									$imageTitle=JText::_('JL_ADMIN_USER_FIELDS_EDIT_DETAILS');
									echo JHTML::_(	'image','administrator/components/com_joomleague/assets/images/user_edit.png',
                ...
                ?>
									...
									<?php
									$imageTitle=JText::_('JL_ADMIN_USER_FIELDS_NO_EDIT_DETAILS');
