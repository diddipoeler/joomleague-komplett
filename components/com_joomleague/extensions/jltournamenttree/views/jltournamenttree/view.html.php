...
$document->addScript(JURI::base().'components/com_joomleague/extensions/jltournamenttree/assets/js/jquery.json-2.3.min.js');
$document->addScript(JURI::base().'components/com_joomleague/extensions/jltournamenttree/assets/js/jquery.bracket-3.js');

// Add customstyles
$stylelink = '<link rel="stylesheet" href="'.JURI::base().'components/com_joomleague/extensions/jltournamenttree/assets/css/jquery.bracket-3.css'.'" type="text/css" />' ."\n";
...
//$document->addCustomTag($stylelink);
$stylelink = '<link rel="stylesheet" href="'.JURI::base().'components/com_joomleague/extensions/jltournamenttree/assets/css/jquery.bracket-site.css'.'" type="text/css" />' ."\n";
$document->addCustomTag($stylelink);
