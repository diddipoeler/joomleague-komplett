...
class ImageSelect
{
	...
	function check( $file )
	{
		...
		{
			JError::raiseWarning( 100, JText::_( 'JL_IMAGEHANDLER_UPLOAD_FAILED' ) . ': ' . htmlspecialchars($file['name'], ENT_COMPAT, 'UTF-8' ) );
			return false;
		}
		...
		{
			JError::raiseWarning( 100, JText::_( 'JL_IMAGEHANDLER_ERROR1' ) . ': ' . htmlspecialchars( $file['name'], ENT_COMPAT, 'UTF-8' ) );
			return false;
		}
		...
		{
			JError::raiseWarning( 100, JText::_( 'JL_IMAGEHANDLER_ERROR2' ) . ': ' . htmlspecialchars( $file['name'], ENT_COMPAT, 'UTF-8' ) );
			return false;
		}
		...
		foreach( $html_tags as $tag )
		{
			...
			{
				JError::raiseWarning( 100, JText::_( 'JL_IMAGEHANDLER_IE_WARN' ) );
				return false;
			}
		}
