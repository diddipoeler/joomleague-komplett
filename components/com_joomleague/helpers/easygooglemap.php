...
<?php
  ...
  function RouteForm () {
    ...
    <form onsubmit="if($('saddr').value!='') {loadRoute();return false;} else {alert('INSERT ADDRESS');return false;}">
     ...
     <?php echo JText::_('JL_GMAP_DIRECTIONS_TO');?>: <input type="text" class="inputbox" id="saddr" name="saddr" value="" />
     <input class="inputbox" type="button" onclick="if($('saddr').value!='') loadRoute()" value="<?php echo JText::_('JL_GMAP_DIRECTIONS_SHOW');?>" />
