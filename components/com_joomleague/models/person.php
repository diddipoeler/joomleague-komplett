...
echo $this->pane->startPanel('function getInOutStats person.php','function getInOutStats person.php');      
$this->dump_header("function getInOutStats person.php");
$this->dump_variable("inoutstat", $inoutstat);
