...
<tr id="result-<?php echo $match->id; ?>" class="row-result">
	...
	<td align='center' valign='top'><?php
		$xrounds=array();
		$xrounds[]=JHTML::_('select.option','0',JText::_('JL_RESULTS_REGULAR_TIME'));
		$xrounds[]=JHTML::_('select.option','1',JText::_('JL_RESULTS_OVERTIME2'));
		$xrounds[]=JHTML::_('select.option','2',JText::_('JL_RESULTS_SHOOTOUT2'));
