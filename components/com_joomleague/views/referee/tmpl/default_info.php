							...
							switch ( $this->config['show_birthday'] )
							{
								case 1:	 // show Birthday and Age
											$birthdateStr =	$this->referee->birthday != "0000-00-00" ?
															JHTML::date( $this->referee->birthday, JText::_( 'JL_GLOBAL_DAYDATE' ) ) : "-";
				...
				if (( $this->referee->address != "" ) && ( $this->config[ 'show_person_address' ] ==1  ))
				{
					...
					<tr>
						<td class="label">
								...
								<?php
								echo JText::_( 'JL_PERSON_ADDRESS' );
								?>
			...
			if (($this->config['show_person_email'] == 1) && ( $this->referee->email != "" ))
			{
				...
				if(( $this->referee->height > 0 ) && ($this->config['show_person_height'] == 1))
				{
					...
					<tr>
						...
						<td class="data">
							<?php
							echo str_replace( "%HEIGHT%", $this->referee->height, JText::_( 'JL_PERSON_HEIGHT_FORM' ) );
							?>
						</td>
					</tr>
					<?php
				...
				if (( $this->referee->weight > 0 ) && ($this->config['show_person_weight'] == 1))
				{
					...
					<tr>
						...
						<td class="data">
							<?php
							echo str_replace( "%WEIGHT%", $this->referee->weight, JText::_( 'JL_PERSON_WEIGHT_FORM' ) );
							?>
						</td>
					</tr>
					<?php
				...
				if ( $this->referee->position_name != "" )
				{
					...
					<tr>
						<td class="label">
								...
								<?php
								echo JText::_( 'JL_PERSON_POSITION' );
								?>
				...
				if (( ! empty( $this->referee->knvbnr ) ) && ($this->config['show_person_regnr'] == 1))
				{
					...
					<tr>
						<td class="label">
								...
								<?php
								echo JText::_( 'JL_PERSON_REGISTRATIONNR' );
								?>
