...
else
{
    ...
    if ( $this->club->founded_year )
		{
			?>
			<span class="clubinfo_listing_item"><?php echo JText::_( 'JL_CLUBINFO_FOUNDED_YEAR' ); ?></span>
			<span class="clubinfo_listing_value"><?php echo $this->club->founded_year; ?></span>
			<?php
		}
		if ( $this->club->dissolved )
		{
			?>
			<span class="clubinfo_listing_item"><?php echo JText::_( 'JL_CLUBINFO_DISSOLVED' ); ?></span>
		...
		{
			?>
			<span class="clubinfo_listing_item"><?php echo JText::_( 'JL_CLUBINFO_DISSOLVED_YEAR' ); ?></span>
		...
		{
			?>
			<span class="clubinfo_listing_item"><?php echo JText::_( 'JL_CLUBINFO_UNIQUE_ID' ); ?></span>
