							...
							switch ( $this->config['show_birthday'] )
							{
								case 1:	 // show Birthday and Age
											$birthdateStr =	$this->person->birthday != "0000-00-00" ?
															JHTML::date( $this->person->birthday, JText::_( 'JL_DAYDATE' ) ) : "-";
				...
				if( $this->person->height > 0 )
				{
					...
					<tr>
						<td class="td_r">
							<b>
								<?php
								echo JText::_( 'JL_PLAYER_HEIGHT' );
								?>
							</b>
						</td>
						<td class="td_l">
							<?php
							echo str_replace( "%HEIGHT%", $this->person->height, JText::_( 'JL_PLAYER_HEIGHT_FORM' ) );
							?>
						</td>
					</tr>
					<?php
				...
				if ( $this->person->weight > 0 )
				{
					...
					<tr>
						<td class="td_r">
							<b>
								<?php
								echo JText::_( 'JL_PLAYER_WEIGHT' );
								?>
							</b>
						</td>
						<td class="td_l">
							<?php
							echo str_replace( "%WEIGHT%", $this->person->weight, JText::_( 'JL_PLAYER_WEIGHT_FORM' ) );
							?>
						</td>
					</tr>
					<?php
