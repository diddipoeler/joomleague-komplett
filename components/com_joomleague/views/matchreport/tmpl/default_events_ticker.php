...
<h2><?php echo JText::_('JL_MATCHREPORT_EVENTS'); ?></h2>		

<table class="eventstable" border="0">

		<thead>
	        <tr class="sectiontableheader">
	            <th style="text-align:center"><?php echo JText::_('JL_MATCHREPORT_EVENT_TIME'); ?></th>
	            <th colspan=3><?php echo JText::_('JL_EDIT_EVENTS_EVENT'); ?></th>
	        </tr>
	    </thead>
        ...
        foreach ($this->matchevents AS $me)
            {
                    ...
                    if ($me->event_type_id > 0) {
                        ...
                        if ($pic_tab == 'media/com_joomleague/event_icons/event.gif')
                        {
                            $txt_tab = $eventname;
                        }
                        else
