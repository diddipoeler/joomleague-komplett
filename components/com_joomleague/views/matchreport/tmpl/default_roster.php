...
//echo 'matchplayers <br><pre>'.print_r($this->matchplayers,true).'</pre><br>';
//echo 'match <br><pre>'.print_r($this->match,true).'</pre><br>';
...
|| ( !empty($this->config['show_only_fav_team']) && $this->match->team1_id == $this->project->fav_team ) 
)
{ 
?>
...
<?php
if ( empty($this->config['show_only_fav_team']) 
|| ( !empty($this->config['show_only_fav_team']) && $this->match->team2_id == $this->project->fav_team ) 
)
{ 
?>                    
					<!-- list of guest-team -->
