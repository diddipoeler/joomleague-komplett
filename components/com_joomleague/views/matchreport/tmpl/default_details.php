...
<!-- Details-->
<h2><?php echo JText::_('JL_MATCHREPORT_DETAILS'); ?></h2>
<table width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	if ($this->match->old_match_id > 0)
	{
		...
		<tr>
			<td colspan="3" >
				<span class="label"><?php echo JText::_( 'JL_MATCHREPORT_OLD_MATCH' ); ?></span>
	...
	if ($this->match->new_match_id > 0)
	{
		...
		<tr>
			<td colspan="3" >
				<span class="label"><?php echo JText::_( 'JL_MATCHREPORT_NEW_MATCH' ); ?></span>
    ...
    if ($this->config['show_match_date'] == 1)
    {
        if ($this->match->match_date > 0)
        {
            ...
            <tr>
                <td colspan="3" >
                    <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_DATE' ); ?></span>
                    <span><?php echo JHTML::date($this->match->match_date, JText::_( 'JL_MATCHREPORT_GAMES_DATE' ) ); ?></span>
                </td>
            </tr>
            <?php
        }
    ...
    if ($this->config['show_match_time'] == 1)
    {
        if ($this->match->match_date > 0)
        {
            ...
            <tr>
                <td colspan="3" >
                    <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_TIME' ); ?></span>
	...
	?>
        ...
        <tr>
            <td colspan="3" >
                <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_PRESENT' ); ?></span>
    ...
    if ($this->config['show_match_number'] == 1)
    {
        ...
        <tr>
            <td colspan="3" >
                <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_NUMBER' ); ?></span>
    ...
    if ($this->config['show_match_playground'] == 1)
    {
        ...
        <tr>
            <td colspan="3" >
                <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_PLAYGROUND' ); ?></span>
    ...
    {    
        if ( $this->matchreferees )
        {
            ...
            <tr>
                <td colspan="3" >
                    <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_REFEREE' ); ?></span>
                    <?php
                    $first = true;
    ...
    if ($this->config['show_match_crowd'] == 1)
    {
        if ( $this->match->crowd > 0 ): ?>
            <tr>
            <td>
                <span class="label"><?php echo JText::_( 'JL_MATCHREPORT_ATTENDANCES' ); ?></span>
