...
class JoomleagueViewMatchReport extends JLGView
{
	...
	function display($tpl=null)
	{
        ...
        //echo 'show_only_fav_team -> '.$this->config['show_only_fav_team'].'<br>';
        //echo 'fav_team -> '.$this->project->fav_team.'<br>';
    ...
    $schemahome = $this->assignRef('schemahome',$model->getSchemaHome($this->extended));
    $schemaaway = $this->assignRef('schemaaway',$model->getSchemaAway($this->extended));
