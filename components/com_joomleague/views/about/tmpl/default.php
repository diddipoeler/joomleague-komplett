...
<div class="componentheading">
	<?php echo JText::_('JL_ABOUT');?>
</div>
<table class="about">
	<tr>
		<td><?php echo JText::_('JL_ABOUT_TEXT'); ?></td>
	</tr>
</table>
<br />
<div class="componentheading">
	<?php echo JText::_('JL_ABOUT_DETAILS'); ?>
</div>
<table class="about">
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_VERSION'); ?></b></td>
		<td><?php echo $this->version; ?></td>
	</tr>
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_AUTHOR'); ?></b></td>
		<td><?php echo $this->about->author; ?></td>
	</tr>

	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_WEBSITE'); ?></b></td>
		<td>
	...
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_SUPPORT_FORUM'); ?></b></td>
		<td>
	...
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_BUGS'); ?></b></td>
		<td>
	...
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_WIKI'); ?></b></td>
		<td>
	...
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_DEVELOPERS'); ?></b></td>
		<td><?php echo $this->about->developer; ?></td>
	</tr>
<!--
	<tr>
		<td><b><?php //echo JText::_('JL_ABOUT_SUPPORTERS'); ?></b></td>
		<td><?php //echo $this->about->supporters; ?></td>
	</tr>
	<tr>
		<td><b><?php //echo JText::_('JL_ABOUT_TRANSLATORS'); ?></b></td>
		<td><?php //echo $this->about->translator; ?></td>
	</tr>
-->
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_DESIGNER'); ?></b></td>
		<td><?php echo $this->about->designer; ?></td>
	</tr>
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_ICONS'); ?></b></td>
		<td><?php echo $this->about->icons; ?></td>
	</tr>
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_FLASH_STATISTICS'); ?></b></td>
		<td><?php echo $this->about->flash; ?></td>
	</tr>
	<tr>
		<td><b><?php echo JText::_('JL_ABOUT_PHPTHUMB'); ?></b></td>
		<td><?php echo $this->about->phpthumb; ?></td>
	</tr>	
<!--
	<tr>
		<td><b><?php //echo JText::_('JL_ABOUT_GRAPHIC_LIBRARY'); ?></b></td>
...
<br />
<div class="componentheading">
	<?php echo JText::_('JL_ABOUT_LICENSE'); ?>
</div>
<table class="about">
	<tr>
		<td><?php echo JText::_('JL_ABOUT_LICENSE_TEXT'); ?></td>
	</tr>
</table>
<!-- backbutton -->
<?php
