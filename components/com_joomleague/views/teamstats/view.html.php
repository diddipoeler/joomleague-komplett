...
class JoomleagueViewTeamStats extends JLGView
{
	function display($tpl = null)
	{
		...
		// Set page title
		$pageTitle = JText::_( 'JL_TEAMSTATS_PAGE_TITLE' );
		if ( isset( $this->team ) )
		{
	...
	function _setChartdata($config)
	{
		...
		$baragainst->set_key(JText::_('JL_TEAMSTATS_GOALS_AGAINST'), 12);
		...
		$chart->set_x_axis( $x );
		$x_legend = new x_legend( JText::_('JL_TEAMSTATS_ROUNDS') );
		...
		$chart->set_y_axis( $y );
		$y_legend = new y_legend( JText::_('JL_TEAMSTATS_GOALS') );
