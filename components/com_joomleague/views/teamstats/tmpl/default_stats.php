			...
			?>
				...
				<tr class="sectiontableentry1">
					...
					<?php if ( $this->config['home_away_stats'] ): ?>
						<?php if (!empty($this->highest_home)): ?>
					<td class="statvalue">
						<?php echo $this->highest_home->homegoals . $this->overallconfig['seperator'] . $this->highest_home->guestgoals; ?>
						<br>
						<?php echo $this->highest_home->hometeam . "<br>" . $this->overallconfig['seperator'] . "<br>" . $this->highest_home->guestteam; ?>
					</td>
					<?php else: ?>
					<td class="statvalue">
					----
					...
					<td class="statvalue">
						<?php echo $this->highest_away->homegoals . $this->overallconfig['seperator'] . $this->highest_away->guestgoals; ?>
						<br>
						<?php echo $this->highest_away->hometeam . "<br>" . $this->overallconfig['seperator'] . "<br>" . $this->highest_away->guestteam; ?>
					</td>
					<?php else: ?>	
					<td class="statvalue">
					----
				...
				<tr class="sectiontableentry2">
					...
					<?php if ( $this->config['home_away_stats'] ): ?>
						<?php if (!empty($this->highestdef_home)): ?>
					<td class="statvalue">
						<?php echo $this->highestdef_home->homegoals . $this->overallconfig['seperator'] . $this->highestdef_home->guestgoals; ?>
						<br>
						<?php echo $this->highestdef_home->hometeam . "<br>" . $this->overallconfig['seperator'] . "<br>" . $this->highestdef_home->guestteam; ?>
					</td>
						<?php else: ?>
					<td class="statvalue">
					----
					...
					<td class="statvalue">
						<?php echo $this->highestdef_away->homegoals . $this->overallconfig['seperator'] . $this->highestdef_away->guestgoals; ?>
						<br>
						<?php echo $this->highestdef_away->hometeam . "<br>" . $this->overallconfig['seperator'] . "<br>" . $this->highestdef_away->guestteam; ?>
					</td>
						<?php else: ?>
					<td class="statvalue">
					----
