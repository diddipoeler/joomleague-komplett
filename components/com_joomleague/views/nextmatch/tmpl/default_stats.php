...
<h2><?php echo JText::_('JL_NEXTMATCH_H2H'); ?></h2>
<table width="96%" align="center" border="0" cellpadding="0" cellspacing="0">
	<thead>
        ...
        <th class="h2h" width="33%">
            ...
            {
                echo JText::_( "JL_NEXTMATCH_UNKNOWNTEAM" );
            }
            ?>
        </th>
			...
			<th  class="h2h" width="33%">
                <?php
                echo JText::_( 'JL_NEXTMATCH_STATS' );
                ?>
            </th>
        <th class="h2h">
            <?php
	...
	?>
        <tr class="sectiontableentry1">
            ...
            <td class="statlabel">
                <?php
                echo JText::_( 'JL_NEXTMATCH_CHANCES' );
                ?>
            </td>
            <td class="valueright">
                <?php
    ...
    ?>		
        <tr class="sectiontableentry2">
            ...
            <td class="statlabel">
                <?php
                echo JText::_( 'JL_NEXTMATCH_CURRENT_RANK' );
                ?>
            </td>
            <td class="valueright">
                <?php
    ...
    ?>
        <tr class="sectiontableentry1">
            ...
            <td class="statlabel">
                <?php
                echo JText::_( 'JL_NEXTMATCH_COUNT_MATCHES' );
                ?>
            </td>
            <td class="valueright">
                <?php
    ...
    if ( $this->config['show_match_total'] == 1 )
    {
        ...
        <tr class="sectiontableentry2">
            ...
            <td class="statlabel">
                   <?php
                echo JText::_('JL_NEXTMATCH_TOTAL');
                ?>
            </td>
            <td class="valueright">
                <?php
...
?>
    <tr class="sectiontableentry1">
        ...
        <td class="statlabel">
			<?php echo JText::_('JL_NEXTMATCH_HOME');?>
		</td>
        <td class="valueright">
        <?php printf(
                "%s/%s/%s",
...
?>
    <tr class="sectiontableentry2">
        ...
        <td class="statlabel">
			<?php echo JText::_('JL_NEXTMATCH_AWAY');?>
		</td>
        <td class="valueright">
        <?php printf(
                "%s/%s/%s",
...
?>
    <tr class="sectiontableentry1">
        ...
        <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_POINTS');?></td>
...
?>
    <tr class="sectiontableentry2">
        ...
        <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_GOALS');?></td>
        <td class="valueright">
        <?php printf(
                "%s : %s",
...
?>
    <tr class="sectiontableentry1">
        ...
        <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_DIFFERENCE');?></td>
        <td class="valueright">
...
<?php if ( $this->config['show_match_highest_stats'] == 1 ): ?>
	...
	<?php if ($this->config['show_match_highest_won'] == 1): ?>
      ...
      <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_HIGHEST_WON_HOME');?></td>
      <td class="valueright">
    ...
    <tr class="sectiontableentry1">
      ...
      <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_HIGHEST_LOSS_HOME');?></td>
      <td class="valueright">
    ...
    <tr class="sectiontableentry2">
      ...
      <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_HIGHEST_WON_AWAY');?></td>
      <td class="valueright">
    ...
    <tr class="sectiontableentry1">
      ...
      <td class="statlabel"><?php echo JText::_('JL_NEXTMATCH_HIGHEST_LOSS_AWAY');?></td>
      <td class="valueright">
