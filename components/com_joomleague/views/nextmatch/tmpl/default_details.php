...
<h2><?php echo JText::_('JL_NEXTMATCH_DETAILS'); ?></h2>
<table
	...
	if ($this->match->old_match_id > 0)
	{
		?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_OLD_MATCH' ); ?></span>
	...
	if ($this->match->new_match_id > 0)
	{
		?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_NEW_MATCH' ); ?></span>
	...
	<!-- Date -->
	<?php if ($this->match->match_date > 0): ?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_DATE' ); ?></span>
	...
	<?php if ($this->match->match_date > 0): ?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_TIME' ); ?></span>
	...
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_PRESENT' ); ?></span>
		<span><?php echo $this->match->time_present; ?></span></td>
	</tr>
	<?php endif; ?>

	<!-- match number -->
	<?php if ($this->match->match_number > 0): ?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_NUMBER' ); ?></span>
	...
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_CANCEL_REASON' ); ?></span>
	...
	<!-- playground -->
	<?php if ($this->match->playground_id > 0): ?>
	<?php $playground_link = JoomleagueHelperRoute::getPlaygroundRoute( $this->project->id, $this->match->playground_id);?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_PLAYGROUND' ); ?></span>
	...
	<!-- referee -->
	<?php if (!empty($this->referees)): ?>
	<?php $html = array(); ?>
	<tr>
		<td colspan="3"><span class=""><?php echo JText::_( 'JL_NEXTMATCH_REFEREE' ); ?></span>
