...
<table class="fixtures" width="96%" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr class="sectiontableheader">
		<th class="name_row"><?php echo JText::_('JL_RIVALS_RIVAL'); ?></th>
		<th class="match_row"><?php echo JText::_('JL_RIVALS_MATCHES'); ?></th>
		<th class="win_row"><?php echo JText::_('JL_RIVALS_WIN'); ?></th>
		<th class="tie_row"><?php echo JText::_('JL_RIVALS_DRAW'); ?></th>
		<th class="los_row"><?php echo JText::_('JL_RIVALS_LOS'); ?></th>
		<th class="goals_row"><?php echo JText::_('JL_RIVALS_TOTAL_GOALS'); ?></th>
	</tr>
	<?php
	$k=0;
