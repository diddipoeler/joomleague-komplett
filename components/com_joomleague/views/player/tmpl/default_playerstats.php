...
//echo "<b>default_playstats.php this->historyPlayer</b><pre>".print_r($this->historyPlayer,true)."</pre>";
...
//echo "<b>default_playstats.php this->inoutstat</b><pre>".print_r($this->inoutstat,true)."</pre>";
