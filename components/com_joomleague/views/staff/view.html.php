...
class JoomleagueViewStaff extends JLGView
{
	...
	function display($tpl=null)
	{
		...
		$titleStr=JText::sprintf('JL_STAFF_ABOUT_AS_A_STAFF', JoomleagueHelper::formatName(null, $this->person->firstname, $this->person->nickname, $this->person->lastname, $this->config["name_format"]));		
