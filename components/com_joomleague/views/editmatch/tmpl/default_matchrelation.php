...
<fieldset class="adminform">
	<legend>
		<?php
		echo JText::_( 'JL_EDITMATCH_MATCHRELATION' );
		?>
	</legend>
	<table class='adminForm' cellpadding='0' cellspacing='7' border='0'>
		<tr>
			<td><label><?php echo JText::_( 'JL_EDITMATCH_MATCHRELATION_PREV_MATCH' ); ?></label></td>
			<td>
				<?php
		...
		<tr>
			<td><label><?php echo JText::_( 'JL_EDITMATCH_MATCHRELATION_NEW_MATCH' ); ?></label></td>
			<td>
				<?php
