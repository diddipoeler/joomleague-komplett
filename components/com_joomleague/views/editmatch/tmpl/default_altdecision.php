...
<fieldset class="adminform">
	<legend><?php echo JText::_( 'JL_EDITMATCH_ALTDECISION' ); ?></legend>
	<table>
		<tr>
			<td align="left">
				<?php
				echo JText::_( 'JL_EDITMATCH_ALTDECISION_RATE_MATCH' );
				?>
			</td>
			<td>
				<?php
		...
		<tr>
			<td>
				<?php
				echo JText::_( 'JL_EDITMATCH_ALTDECISION_RESULT_DECISION' );
				?>
			</td>
			<td>
				...
				<div	id="alt_decision_enter"
					...
					<table>
						<tr>
							<td align="left">
								<?php
								echo JText::_( 'JL_EDITMATCH_ALTDECISION_NEW_SCORE_HOMETEAM' );
								?>
							</td>
							<td>
						...
						<tr>
							<td align="left">
								<?php
								echo JText::_( 'JL_EDITMATCH_ALTDECISION_NEW_SCORE_GUESTTEAM' );
								?>
							</td>
							<td>
						...
						<tr>
							<td align="left">
								<?php
								echo JText::_( 'JL_EDITMATCH_ALTDECISION_NOTICE' );
								?>
							</td>
							<?php
