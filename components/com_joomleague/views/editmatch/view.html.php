...
class JoomleagueViewEditMatch extends JLGView
{
	function display($tpl=null)
	{
		...
		// extended match data
		$paramsdata	= $this->match->extended;
		...
		$oldmatches[] = JHTML::_('select.option','0',JText::_('JL_EDITMATCH_SELECT_PREV_MATCH'));
		$res = array();
		...
		$newmatches[] = JHTML::_('select.option','0',JText::_('JL_EDITMATCH_SELECT_NEW_MATCH'));
		$res = array();
		...
		$pageTitle = JText::_('JL_EDITMATCH_MATCHDETAILS');
