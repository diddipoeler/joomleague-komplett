...
<table class="fixtures">
	<tr class="sectiontableheader">
		<td><?php echo JText::_('JL_TEAMINFO_SEASON_TITLE');?></td>
	</tr>
</table>
...
if ($season->projectname)
{
	...
	<tr>
		...
		?> <a href="javascript:void(0)"
			...
			title="<?php echo JText::_('JL_SHOW_OPTIONS'); ?>"><?php echo $season->projectname; ?>
		</a> <?php
		/*
		 //Maybe this thing with ul and li should be solved by css so everybody may decide for himself about using it or not
		 </li>
...
/*
 ...
 <tr>
 <td>
 <b><?php echo JText::_('JL_TEAMINFO_TEAMSEASON_DESC');?></b>
 </td>
...
<div id="tid<?php echo $this->team->id . $season->projectid;?>"
	...
	if ($this->config['show_teams_logos'])
	{
		...
		$picture_descr = JText::_("JL_TEAMINFO_PLAYERS_PICTURE") . " " . $this->team->name . " (" . $season->projectname . ")";
	...
	echo JHTML::link($link, JText::_('JL_TEAMINFO_SEASON_PLAYERS'));
	?> <br />
	<?php
	$link = JoomleagueHelperRoute::getResultsRoute($season->project_slug);
	echo JHTML::link($link, JText::_('JL_TEAMINFO_SEASON_RESULTS'));
	?> <br />
	<?php
	$link = JoomleagueHelperRoute::getRankingRoute($season->project_slug);
	echo JHTML::link($link, JText::_('JL_TEAMINFO_SEASON_TABLES'));
	?> <br />
</div>
	<?php
	}
