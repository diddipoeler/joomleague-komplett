...
if (!isset($this->team))
{
	JError::raiseWarning('ERROR_CODE', JText::_('JL_TEAMINFO_ERROR'));
}
else
{
...
<div class="right-column">
	...
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"><?php echo JText::_('JL_TEAMINFO_CLUB_ADDRESS'); ?></span>
				<?php
			...
			if ($this->club->phone)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_CLUB_PHONE'); ?></span>
		<span class="clubinfo_listing_value"> <?php echo $this->club->phone; ?></span>
			...
			if ($this->club->fax)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_CLUB_FAX'); ?></span>
		<span class="clubinfo_listing_value"> <?php echo $this->club->fax; ?></span>
			...
			if ($this->club->email)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_CLUB_EMAIL'); ?></span>
		...
		?>
			...
			if ($this->club)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_CLUB_NAME'); ?></span>
		<span class="clubinfo_listing_value"> <?php
		...
		?>
			...
			if ($this->club->website)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_CLUB_SITE'); ?></span>
		...
		if ($this->config['show_team_info'])
		{
			?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_TEAM_NAME'); ?></span>
		<span class="clubinfo_listing_value"> <?php
	...
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_TEAM_NAME_SHORT'); ?></span>
		<span class="clubinfo_listing_value"> <?php
		...
		?>
			...
			if ($this->team->info)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_INFO'); ?></span>
		<span class="clubinfo_listing_value"> <?php echo $this->team->info; ?></span>
			...
			if ($this->team->website)
			{
				?>
	<div class="jl_parentContainer">
		<span class="clubinfo_listing_item"> <?php echo JText::_('JL_TEAMINFO_TEAM_SITE'); ?></span>
