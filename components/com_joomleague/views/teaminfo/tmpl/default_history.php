...
<table width="100%" class="contentpaneopen">
	<tr>
		<td class="contentheading"><?php echo '&nbsp;' . JText::_('JL_TEAMINFO_HISTORY'); ?>
		</td>
	</tr>
</table>
...
<table class="fixtures">
	<tr class="sectiontableheader">
		<td><?php echo JText::_('JL_TEAMINFO_SEASON'); ?></td>
		<td><?php echo JText::_('JL_TEAMINFO_LEAGUE'); ?></td>
		<?php if($this->project->project_type=='DIVISIONS_LEAGUE') { ?> 
		<td><?php echo JText::_('JL_TEAMINFO_DIVISION'); ?></td>
		<?php } ?> 
		<td><?php echo JText::_('JL_TEAMINFO_RANK'); ?></td>
		<td><?php echo JText::_('JL_TEAMINFO_TOTAL_GAMES'); ?></td>
		<td><?php echo JText::_('JL_TEAMINFO_TOTAL_POINTS'); ?></td>
		<td><?php echo JText::_('JL_TEAMINFO_TOTAL_WDL'); ?></td>
		<td><?php echo JText::_('JL_TEAMINFO_TOTAL_GOALS'); ?></td>
		<td><?php echo JText::_('JL_TEAMINFO_TOTAL_PLAYERS'); ?></td>
	</tr>
	<?php
	$k=0;
