...
class JoomleagueViewStats extends JLGView
{
	function display($tpl = null)
	{
		...
		// Set page title
		$pageTitle = JText::_( 'JL_STATS_PAGE_TITLE' );
		if ( isset( $this->project ) )
		{
	...
	function _setChartdata($config)
	{
		...
		$chart->set_x_axis( $x );
		$x_legend = new x_legend( JText::_('JL_STATS_ROUNDS') );
		...
		$chart->set_y_axis( $y );
		$y_legend = new y_legend( JText::_('JL_STATS_GOALS') );
