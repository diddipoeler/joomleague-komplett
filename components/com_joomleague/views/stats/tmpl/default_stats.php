...
<thead>
	<tr class="sectiontableheader">
		<th colspan="2"><?php	echo JText::_('JL_STATS_GENERAL'); ?></th>
	</tr>
</thead>
<tbody>
	<tr class="sectiontableentry1">
		<td class="statlabel"><?php	echo JText::_('JL_STATS_MATCHDAYS'); ?>:</td>
		<td class="statvalue"><?php	echo $this->totalrounds; ?></td>
	</tr>
	<tr class="sectiontableentry2">
		<td class="statlabel"><?php	echo JText::_('JL_STATS_CURRENT_MATCHDAY');	?>:
		</td>
		<td class="statvalue"><?php	echo $this->actualround; ?></td>
	</tr>
	<tr class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_MATCHES_PER_MATCHDAY'); ?>:</td>
		<td class="statvalue"><?php	echo ($this->totalrounds > 0 ? round (($this->totals->totalmatches / $this->totalrounds),2) : 0); ?>
		</td>
	</tr>
	<tr class="sectiontableentry2">
		<td class="statlabel"><?php echo JText::_('JL_STATS_MATCHES_OVERALL');?>:</td>
		<td class="statvalue"><?php	echo $this->totals->totalmatches;?></td>
	</tr>
	<tr  class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_MATCHES_PLAYED');?>:</td>
		<td class="statvalue"><?php	echo $this->totals->playedmatches;?></td>
	</tr>
	
	<?php	if ($this->config['home_away_stats']): ?>
	<tr  class="sectiontableentry2">
		<td class="statlabel"><b><?php echo JText::_('JL_STATS_MATCHES_HIGHEST_WON_HOME');?>:</b>
		<br />
		<?php
	...
	<tr  class="sectiontableentry1">
		<td class="statlabel"><b><?php echo JText::_('JL_STATS_MATCHES_HIGHEST_WON_AWAY');?>:</b>
		<br />
		<?php
	...
	<?php	else :
		...
		?>
	<tr  class="sectiontableentry2">
		<td class="statlabel"><b><?php echo JText::_('JL_STATS_MATCHES_HIGHEST_WIN');?>:</b>
		<br />
