...
<thead>
	<tr class="sectiontableheader">
		<th colspan="2"><?php echo JText::_('JL_STATS_GOALS');?></th>
	</tr>
</thead>
<tbody>
	<tr  class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_TOTAL');?>:</td>
		<td class="statvalue"><?php echo $this->totals->sumgoals;?></td>
	</tr>
	<tr  class="sectiontableentry2">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_TOTAL_PER_MATCHDAY');?>:</td>
	...
	<tr  class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_TOTAL_PER_MATCH');?>:</td>
		<td class="statvalue"><?php
			if (	 $this->totals->playedmatches>0 )
			{
	...
	<tr  class="sectiontableentry2">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_HOME');?></td>
		<td class="statvalue"><?php echo $this->totals->homegoals;?></td>
	</tr>
	<tr  class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_HOME_PER_MATCHDAY');?>:</td>
		<td class="statvalue"><?php
			if ( $this->totals->playedmatches>0 )
			{
	...
	<tr  class="sectiontableentry2">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_HOME_PER_MATCH');?>:</td>
		<td class="statvalue"><?php
			if ( $this->totals->playedmatches > 0 )
			{
	...
	<tr  class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_AWAY');?></td>
		<td class="statvalue"><?php echo $this->totals->guestgoals;?></td>
	</tr>
	<tr  class="sectiontableentry2">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_AWAY_PER_MATCHDAY');?>:</td>
		<td class="statvalue"><?php
			if ( $this->totals->playedmatches > 0 )
			{
	...
	<tr  class="sectiontableentry1">
		<td class="statlabel"><?php echo JText::_('JL_STATS_GOALS_AWAY_PER_MATCH');?>:</td>
		<td class="statvalue"><?php
			if ( $this->totals->playedmatches > 0 )
			{
