...
<fieldset class="adminform">
	<legend><?php echo JText::sprintf('JL_EDIT_EVENTS_EDIT_LINEUP',$this->awayteam->name); ?></legend>
	<table border='0'>
		<tr>
			<td style='text-align:center; ' colspan='4'>
				<input type="submit" class="inputbox" value="<?php echo JText::_('JL_EDIT_EVENTS_SAVE_LINEUP'); ?>" />
			</td>
		</tr>
		<tr>
			<td style='text-align:center; '><p><b><?php echo JText::_('JL_EDIT_EVENTS_AVAILABLE_PLAYERS'); ?></b></p></td>
			<td>&nbsp;</td>
			<td style='text-align:center; '><p><b><?php echo JText::_('JL_EDIT_EVENTS_PLAYERS_ASSIGNED'); ?></b></p></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
		...
		foreach ($this->playerprojectpositions AS $project_position_id => $pos)
		{
			...
			<tr>
				<td style='text-align:center; vertical-align:middle; '>
					...
					//$attribs 	array() 	Attribute des Links,müssen als Array in der Form array('name' => 'wert') übergeben werden
