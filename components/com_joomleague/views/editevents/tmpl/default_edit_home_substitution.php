...
<div id="io">
	...
	<fieldset class="adminform">
		<legend>
			<?php
			echo JText::sprintf( 'JL_EDIT_EVENTS_EDIT_SUBSTITUTIONS', $this->hometeam->name );
			?>
		</legend>
		<table border='0'>
			<thead>
				<tr>
					...
					<th>
						<?php
						echo JText::_( 'JL_EDIT_EVENTS_POSITION' );
						?>
					</th>
					<th>
						<?php
			...
			<tbody>
				...
				<tr id="row-new-home">
					...
					<td>
						<input id="save-new-home" type="button" class="inputbox button-save-homesubst" value="<?php echo JText::_( 'JL_EDIT_EVENTS_SAVE' ); ?>" />
					</td>
				</tr>
			</tbody>
		</table>
