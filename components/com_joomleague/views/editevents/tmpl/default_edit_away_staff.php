...
<fieldset class="adminform">
	<legend><?php echo JText::sprintf('JL_EDIT_EVENTS_EDIT_STAFF',$this->awayteam->name); ?></legend>
	<table border='0'>
		<tr>
			<td style='text-align:center; ' colspan='4'>
				<input type="submit" class="inputbox"	value="<?php echo JText::_('JL_EDIT_EVENTS_SAVE_STAFF'); ?>" />
			</td>
		</tr>
		<tr>
			<td style='text-align:center; '><p><b><?php echo JText::_('JL_EDIT_EVENTS_AVAILABLE_STAFF'); ?></b></p></td>
			<td>&nbsp;</td>
			<td style='text-align:center; '><p><b><?php echo JText::_('JL_EDIT_EVENTS_STAFF_ASSIGNED'); ?></b></p></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
