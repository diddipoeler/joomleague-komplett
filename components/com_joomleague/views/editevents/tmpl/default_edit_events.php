...
<!--
	...
	var str_delete = "<?php echo JText::_('JL_EDIT_EVENTS_DELETE'); ?>";
...
<div id="gamesevents">
	...
	<fieldset class="adminform">
		<legend>
			<?php
			echo JText::_( 'JL_EDIT_EVENTS_ADD_EDIT_DELETE' );
			?>
		</legend>
		<table border='0' >
			<thead>
				<tr>
					<th style='text-align:left; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_TEAM' ); ?></th>
					<th style='text-align:left; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_PLAYER' ); ?></th>
					<th style='text-align:left; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_EVENT' ); ?></th>
					<th style='text-align:center; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_SUM' ); ?></th>
					<th style='text-align:center; ' >
						<?php
						echo JText::_( 'JL_EDIT_EVENTS_TIME' );
						#echo JText::_( 'Hrs' ) . ' ' . JText::_( 'Mins' ) . ' ' . JText::_( 'Secs' );
						?>
					</th>
					<th style='text-align:center; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_NOTICE' ); ?></th>
					<th style='text-align:center; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_ACTION' ); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php
						...
						<tr id="row-<?php echo $event->event_id; ?>">
							...
							<td style='text-align:center; ' >
								<input	id="delete-<?php echo $event->event_id; ?>" type="button" class="inputbox button-delete"
										value="<?php echo JText::_( 'JL_EDIT_EVENTS_DELETE' ); ?>" />
							</td>
						</tr>
						<?php
						}
				...
				<tr id="row-new-event">
					...
					<td style='text-align:center; ' >
						<input id="save-new-event" type="button" class="inputbox button-save" value="<?php echo JText::_( 'JL_EDIT_EVENTS_SAVE' ); ?>" />
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table border='0' >
			<thead>
				<tr>
					<th style='text-align:left; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_LIVE_TYPE' ); ?></th>
					<th style='text-align:center; ' >
						<?php
						echo JText::_( 'JL_EDIT_EVENTS_TIME' );
						#echo JText::_( 'Hrs' ) . ' ' . JText::_( 'Mins' ) . ' ' . JText::_( 'Secs' );
					...
					<th style='text-align:center; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_LIVE_NOTES' ); ?></th>
					<th style='text-align:center; ' ><?php echo JText::_( 'JL_EDIT_EVENTS_ACTION' ); ?></th>
				</tr>
			</thead>
			<tbody>
						...
						<tr id="row-<?php echo $event->event_id; ?>">
							<td>
								...
								switch ($event->event_sum) {
                                    case 2:
                                        echo JText::_( 'JL_EDIT_EVENTS_LIVE_TYPE_2' );
                                        break;
                                    case 1:
                                        echo JText::_( 'JL_EDIT_EVENTS_LIVE_TYPE_1' );
                                        break;
		                        } ?>
							</td>
				...
				<tr id="row-new-comment">
					...
					<td>
						<select name="ctype" id="ctype" class="inputbox select-commenttype">
                            <option value="1"><?php echo JText::_( 'JL_EDIT_EVENTS_LIVE_TYPE_1' ); ?></option>
                            <option value="2"><?php echo JText::_( 'JL_EDIT_EVENTS_LIVE_TYPE_2' ); ?></option>
                        </select> 
					</td>
					<td style='text-align:center; ' >
					...
					<td style='text-align:center; ' >
						<input id="save-new-comment" type="button" class="inputbox button-save-c" value="<?php echo JText::_( 'JL_EDIT_EVENTS_SAVE' ); ?>" />
					</td>
				</tr>
			</tbody>
		</table>
