...
<fieldset class="adminform">
	<legend>
		<?php
		echo JText::_('JL_EDIT_EVENTS_EDIT_STARTING_REFEREES');
		if ($this->project->teams_as_referees)
		{
			echo '&nbsp;-&nbsp;<i>' . JText::_('JL_EDIT_EVENTS_ONLY_TEAMS_AS_REFEREES') . '</i>';
		}
		?>
	</legend>
	<table border='0'>
		<tr>
			<td style='text-align:center; ' colspan='4'>
				<input type="submit" class="inputbox" value="<?php echo JText::_('JL_EDIT_EVENTS_SAVE_STARTING_REFEREES'); ?>" />
			</td>
		</tr>
		<tr>
			<td style='text-align:center; '><p><b><?php echo JText::_('JL_EDIT_EVENTS_AVAILABLE_REFEREES'); ?></b></p></td>
			<td>&nbsp;</td>
			<td style='text-align:center; '><p><b><?php echo JText::_('JL_EDIT_EVENTS_ASSIGNED_REFEREES'); ?></b></p></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
