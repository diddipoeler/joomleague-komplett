...
<div id="io">
	...
	<fieldset class="adminform">
		<legend><?php echo JText::sprintf('JL_EDIT_EVENTS_EDIT_SUBSTITUTIONS',$this->awayteam->name); ?></legend>
		<table border='0'>
			<thead>
				<tr>
					<th>
						<?php
						echo JHTML::_('image','administrator/components/com_joomleague/assets/images/out.png',JText::_('JL_EDIT_EVENTS_OUT'));
						echo ' '.JText::_('JL_EDIT_EVENTS_WENT_OUT');
						?>
					</th>
					<th>
						<?php
						echo JText::_('JL_EDIT_EVENTS_CAME_IN').' ';
						echo JHTML::_('image','administrator/components/com_joomleague/assets/images/in.png',JText::_('JL_EDIT_EVENTS_IN'));
						?>
					</th>
					<th><?php echo JText::_('JL_EDIT_EVENTS_POSITION'); ?></th>
					<th><?php echo JText::_('JL_EDIT_EVENTS_TIME'); ?></th>
					<th>&nbsp;</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr id="row-new-away">
					...
					<td><input id="save-new-away" type="button" class="inputbox button-save-awaysubst" value="<?php echo JText::_('JL_EDIT_EVENTS_SAVE'); ?>" /></td>
				</tr>
			</tbody>
		</table>
	</fieldset>
